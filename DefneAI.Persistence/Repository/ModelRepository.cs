...
public sealed class ModelRepository(
    ...
    IChatClientFactory chatClientFactory) : IModelRepository
{
    ...
    public async Task<string> AddModel(AIModelProvider provide)
    {
        ...
        return $"Model eklendi: {provide.ServiceId}";
    }
        ...
        string argumentValue)
    {
        ...
        switch (normalizedArgumentName)
        {
            ...
            case "serviceid":
                ...
                {
                    return "ServiceId başka bir model tarafından kullanılıyor";
                }
